...
(function($){
    ...
    $(".scorrer-next").on('click', function () {
        owl.trigger('owl.next');
    })
    $(".scorrer-prev").on('click', function () {
...
(function($){
    ...
    $(".scorrer-rank-next").on('click', function () {
        owl.trigger('owl.next');
    })
    $(".scorrer-rank-perv").on('click', function () {
        owl.trigger('owl.prev');
    })
})(jQuery);
...
(function($){
    ...
    $(".assist-rank-next").on('click', function () {
        owl.trigger('owl.next');
    })
    $(".assist-rank-perv").on('click', function () {
        owl.trigger('owl.prev');
    })
})(jQuery);
